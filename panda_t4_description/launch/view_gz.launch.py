...
def generate_launch_description() -> LaunchDescription:
    ...
    panda_desc_pkg = get_package_share_directory("panda_t4_description")
    gz_resource_path = SetEnvironmentVariable(
        name='GZ_SIM_RESOURCE_PATH',
        value=[
            panda_desc_pkg,
            ':',
            os.path.join(panda_desc_pkg, "panda"),
            ':',
            os.path.join(panda_desc_pkg, 'worlds'),
            ':',
    ...
    nodes = [
        ...
        Node(
            ...
            executable="create",
            output="log",
            # arguments=["-string", _robot_description_xml, "--ros-args", "--log-level", log_level],
...
def generate_declared_arguments() -> List[DeclareLaunchArgument]:
    ...
    return [
        ...
        DeclareLaunchArgument(
            "description_package",
            default_value="panda_t4_description",
        ...
        DeclareLaunchArgument(
            ...
            # default_value=path.join("worlds", "arm_on_the_table.sdf"),
